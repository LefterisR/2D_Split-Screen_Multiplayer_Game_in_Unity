...
public class KnightControllerNewInput : MonoBehaviour
{
    ...
    public bool IsDashing 
    {
        ...
        set 
        {
            if (dashTimeLeft > 0) _isDashing = true;
        }
    }
    ...
    private void FixedUpdate()
    {
        if (CanMove)
        {
            ...
            if(!IsDashing) ImplementArcadeJumpPh();
            ...
            if (IsDashing) rbKnight.AddForce(new(transform.localScale.x * dashSpeed,0));
        }
    }
